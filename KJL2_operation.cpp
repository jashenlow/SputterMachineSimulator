...
void KJL2Operation::setUiPointers(Ui::MainWindow *ptr)
{
    ...
    connect(m_rampTimer, &QTimer::timeout, this, &KJL2Operation::rampTimer_timeout, Qt::QueuedConnection);
}
...
void KJL2Operation::outputRamping(bool mode)     //true = Turning output ON or changing setpoint. false = Turning output OFF.
{
    if (mode)
    {
